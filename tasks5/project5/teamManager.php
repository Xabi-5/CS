...
if(isset($_GET["command"])){
    if($_GET["command"] == "add"){
        if(isset($_GET['name'])){
            try{
                $team = new Team;
                $team->setValues(test_input($_GET['name']), test_input($_GET['car']), test_input($_GET['driverNumber1']),
                test_input($_GET['driverNumber2']), test_input($_GET['colour']), test_input($_GET['country']),test_input($_GET['headquarters']));
                $con = new DBmanager;
                $con->openConnection();
                $con->addTeam($team);
        ...
        if(isset($_GET['name'])){
            try{
                ...
                $team->setValues(test_input($_GET['name']), test_input($_GET['car']), test_input($_GET['driverNumber1']),
                test_input($_GET['driverNumber2']), test_input($_GET['colour']), test_input($_GET['country']),test_input($_GET['headquarters']));
                $team->setTeamID(test_input($_GET['teamID']));
                $con = new DBmanager;
                $con->openConnection();
                $con->updateTeam($team);
        ...
        if(isset($_GET['teamID'])){
            try{
                $con = new DBmanager;
                $con->openConnection();
                $con->removeTeam(test_input($_GET['teamID']));
    ...
    try{
        ...
        foreach ($teams as $team){
            ...
            echo '<td style="text-align:center">'.$driver1->getDriverNumber().'. ' .$driver1->getName().' '.$driver1->getSurname().'<br>---------------<br>'.
            $driver2->getDriverNumber().'. ' .$driver2->getName().' '.$driver2->getSurname().'</td></tr>';
        }
        echo'</table><br><br>';
        teamSidebar();
        $con->closeConnection();
