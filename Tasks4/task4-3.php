<?php 
    abstract class Vehiculo{
        ...
        abstract public function getImposto();
    ...
    class Camion extends Vehiculo{
        ...
        {
            return ($this->getCilindrada() /30) + ($this->getPotencia() *20) + 
            ($this->getNumeroRodas()*20) + ($this->getEixes() * 50);
        }
    }
    ...
    echo $moto->toString();
    echo '<br>';
    echo 'Imposto moto1: '.round($moto->getImposto(),2).'€';
    echo '<br>';

    echo $moto2->toString();
    echo '<br>';
    echo 'Imposto moto2: '.round($moto2->getImposto(),2).'€';
    echo '<br>';
    echo $camion->toString();
    echo '<br>';
    echo 'Imposto camion1: '.round($camion->getImposto(),2).'€';
    echo '<br>';
    echo $camion2->toString();
    echo '<br>';
    echo 'Imposto camion2: '.round($camion2->getImposto(),2).'€';
